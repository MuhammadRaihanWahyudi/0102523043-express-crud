...
// Bypass TypeScript: Paksa jwt menggunakan tipe data any agar tidak memicu garis merah
...
const generateToken = (payload: any): string => {
  ...
  return jwt.sign(payload, secret, { expiresIn: jwtExpires });
};
...
export const login = async (req: Request, res: Response) => {
  try {
    ...
    // Memanggil fungsi pembantu yang sudah aman dari eror type
